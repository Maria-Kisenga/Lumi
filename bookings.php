...
$sql = "SELECT name, booked FROM users WHERE user_id = $user";
          ...
          <div class="container">
            <div class="row section-heading justify-content-center mb-5">
              <div class="col-md-8 text-center">
                <h3 class="heading mb-3"><?php echo ucfirst($hold['name']);?>'s Bookings</h3>
				<hr style="width:30%;"/>
              </div>
            </div>
            <div class="row justify-content-center">
              <div class="col-md-12">
                <div class="tab-content" id="pills-tabContent">
				  ...
				  //echo $bookings;
				  if(is_null($b)) {
					  echo "<br/><br/><center><span style='color: #CC947C; font-weight: bold;'>No bookings yet</span></center>";
					  echo "<center><span>Make first booking?</span> <a href= 'index.php#section-menu'>Do it now</a></center>";
				  } 
				  else {
				  //$user = $_SESSION['user_id'];
				  //echo $user;
                  $query="SELECT * FROM recipes WHERE recipe_id IN (" . implode(",",$bookings) . ") AND user_id = '".$user."' ORDER BY recipe_id desc;";
				  //echo $b;
				  ...
				  ?>
                    <div class="d-block d-md-flex menu-food-item">
                      <div class="text order-1 mb-3">
						...
						<center><p style="display: inline; font-weight:bold;"><u><a style="color:#CC947C;" href="remove.php?id=<?php echo $row["recipe_id"]; ?>">I don't want to attend this event anymore</a></u></p></center>
                      </div>
